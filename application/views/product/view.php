         ...
         <tbody>
            <?php foreach ($products as $product) : ?>
               <tr>
                  ...
                  <td>
                     <div class="btn-group">
                        <?php if ($this->user->role === "admin") { ?><a class="btn btn-default" href="javascript:void(0)" data-toggle="popover" data-placement="left" data-html="true" title='<?= label("Areyousure"); ?>' data-content='<a class="btn btn-danger" href="products/delete/<?= $product->id; ?>"><?= label("yesiam"); ?></a>'><i class="fa fa-times" style=""></i></a><?php } ?>
         ...
         <div class="modal-body" id="modal-body">
            <div id="printmenusection">
               <div id="printSectionInvoice">
                  <center>
                     <h1 style="font-family: 'Pinyon Script', cursive;font-size:65px;">Menu</h1>
                  </center>
                  <?php foreach ($categories as $category) : ?>
                     <div class="headline">
                        <h1>
