        ...
        <table class="table">
          ...
          <?php foreach ($Users as $user) : ?>
            <tr>
              ...
              <td>
                <div class="btn-group">
                  <?php if ($this->user->role === "admin") { ?><a class="btn btn-default" href="javascript:void(0)" data-toggle="popover" data-placement="left" data-html="true" title='<?= label("Areyousure"); ?>' data-content='<a class="btn btn-danger" href="settings/deleteUser/<?= $user->id; ?>"><?= label("yesiam"); ?></a>'><i class="fa fa-times" style=""></i></a><?php } ?>
...
<script type="text/javascript">
  ...
  $('input[type=radio][name=role][value="admin"]').prop('checked', true);
</script>